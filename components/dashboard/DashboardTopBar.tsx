      ...
      <div className="bg-[#fdfdfd] border-b border-gray-100 px-4 py-3 flex items-center gap-3 shrink-0">
            ...
            <button
              onClick={() =>
                navigator.clipboard.writeText(
                  `${process.env.NEXT_PUBLIC_APP_URL}/${appUsername}`,
                )
              }
        ...
        >
          ...
          <button
            ...
            title="Log out"
            className="w-8 h-8 lg:hidden flex items-center justify-center rounded-lg text-gray-400 hover:text-red-500 hover:bg-red-50 transition-colors shrink-0"
          >
            <svg
              width="16"
              height="16"
