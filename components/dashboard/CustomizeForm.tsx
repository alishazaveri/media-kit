...
export function CustomizeForm({
  ...
  const [openModal, setOpenModal] = useState<null | "featured" | "campaign">(
    null,
  );
      ...
      {openModal !== null && (
        ...
        >
          ...
          >
            <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100 shrink-0">
              <div>
                ...
                <p className="text-xs text-gray-400 mt-0.5">
                  {
                    (openModal === "campaign" ? campaignIds : featuredIds)
                      .length
                  }{" "}
                  of 4 selected
                </p>
            ...
            {(openModal === "campaign" ? campaignIds : featuredIds).length >=
              4 && (
