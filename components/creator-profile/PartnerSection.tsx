          ...
          <div className="mb-16">
            ...
            <div className="bg-white rounded-3xl p-8 shadow-sm">
              ...
              <div className="flex items-center justify-center gap-3 mt-6">
                <button
                  onClick={prev}
                  className="w-7 h-7 rounded-full border border-gray-200 flex items-center justify-center hover:border-blue-400 transition-colors"
                >
                ...
                <div className="flex gap-1.5">
                  {TESTIMONIALS.map((_, i) => (
                    <button
                      ...
                      className={`rounded-full transition-all ${i === testimonialIdx ? "w-5 h-1.5" : "w-1.5 h-1.5 bg-gray-200"}`}
                      style={
                        i === testimonialIdx
          ...
          >
            <div className="flex flex-col md:flex-row gap-6 md:gap-10">
              <div className="md:w-56 shrink-0">
                ...
                >
                  <path
                    d="M12 3v1M12 20v1M4.22 4.22l.7.7M19.07 19.07l.71.71M3 12H2M22 12h-1M4.22 19.78l.7-.7M19.07 4.93l.71-.71"
                    stroke="#3B5BDB"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                  />
                ...
                <p className="text-sm text-gray-500 leading-relaxed">
                  {tagline
                    ? tagline.slice(0, 80)
                    : "Curious, calm, color-confident. Soft maximalism with a research-driven edge."}{" "}
                  {/* [DUMMY if tagline too long] */}
                </p>
              </div>
              ...
              <div className="flex-1">
                <div className="grid grid-cols-2 gap-3">
                  {vibeTags.map((tag) => (
                    <div
                      key={tag}
                      className="bg-white rounded-2xl px-5 py-3 text-center font-semibold text-gray-700 text-sm"
                    >
                      {tag}
                    </div>
                  ))}
              ...
              <div className="md:w-64 shrink-0 space-y-4">
                <p className="text-sm text-gray-700">
                  <span className="font-bold">Causes:</span> Climate, queer
                  creators, slow fashion. {/* [DUMMY: no causes field] */}
                </p>
                <p className="text-sm text-gray-700">
                  <span className="font-bold">Hobbies:</span> 35mm film,
